...
import com.qinyoucheng.auth.common.UserContextHolder;
...
public class OperationLogAspect {
    ...
    @Resource
    private com.qinyoucheng.auth.system.service.OperationLogService operationLogService;

    @Around("@annotation(com.qinyoucheng.auth.system.aspect.OperationLog)")
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        com.qinyoucheng.auth.system.entity.SysOperationLog logEntity = new com.qinyoucheng.auth.system.entity.SysOperationLog();
